  ...
  return (
    <main style={{minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',background:'#F5F0E8',padding:24,fontFamily:"'Inter',sans-serif"}}>
      ...
      <div style={{background:'#fff',border:'2.5px solid #F9C4A0',borderRadius:20,padding:36,width:'100%',maxWidth:400,textAlign:'center',boxShadow:'4px 4px 0 #F9C4A0'}}>
        ...
        <h1 style={{fontFamily:"'Lilita One',cursive",fontWeight:400,fontSize:24,color:'#F9C4A0',marginBottom:8,letterSpacing:'-0.01em'}}>Choose a new password</h1>
        ...
        {done ? (
          <>
            ...
            <a href="/auth/login" style={{display:'block',padding:'12px 0',background:'#F9C4A0',color:'#fff',borderRadius:100,fontSize:14,fontWeight:700,textDecoration:'none',fontFamily:"'Syne',sans-serif"}}>
              Go to login →
            </a>
          </>
        ) : (
          <>
            ...
            <button
              ...
              style={{width:'100%',padding:'12px 0',background:'#F9C4A0',color:'#fff',border:'none',borderRadius:100,fontSize:14,cursor:'pointer',fontWeight:700,fontFamily:"'Syne',sans-serif",opacity:!password||loading?0.6:1}}
            >
